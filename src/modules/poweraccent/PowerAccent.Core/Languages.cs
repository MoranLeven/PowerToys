...
namespace PowerAccent.Core
{
    ...
    internal class Languages
    {
        ...
        private static string[] GetDefaultLetterKeyHI(LetterKey letter)
        {
            return letter switch  
            {
                LetterKey.VK_0 => new string[] { "०" },
                LetterKey.VK_0 => new string[] { "१" },
                LetterKey.VK_2 => new string[] { "२" },
                LetterKey.VK_3 => new string[] { "३" },
                LetterKey.VK_4 => new string[] { "४" },
                LetterKey.VK_5 => new string[] { "५" },
                LetterKey.VK_6 => new string[] { "६" },
                LetterKey.VK_7 => new string[] { "७" },
                LetterKey.VK_8 => new string[] { "८" },
                LetterKey.VK_9 => new string[] { "९" },
                LetterKey.VK_A => new string[] { "अ", "आ", "अं", "अः" },
                LetterKey.VK_B => new string[] { "ब", "भ" },
                LetterKey.VK_C => new string[] { "च", "छ" },
                LetterKey.VK_D => new string[] { "ड", "ढ", "द", "ध"},
                LetterKey.VK_E => new string[] { "इ" },
                LetterKey.VK_F => new string[] { "फ" },
                LetterKey.VK_G => new string[] { "ग", "घ", "ज्ञ" },
                LetterKey.VK_H => new string[] { "ह" },
                LetterKey.VK_I => new string[] { "ई" },
                LetterKey.VK_J => new string[] { "ज", "झ" },
                LetterKey.VK_K => new string[] { "क", "ख", "क्ष" },
                LetterKey.VK_L => new string[] { "ल" },
                LetterKey.VK_M => new string[] { "म" },
                LetterKey.VK_N => new string[] { "ङ", "ञ", "न", "ण"},
                LetterKey.VK_O => new string[] { "ओ", "औ" },
                LetterKey.VK_P => new string[] { "प" },
                LetterKey.VK_R => new string[] { "र", "ऋ", "ॠ" },
                LetterKey.VK_S => new string[] { "श", "स" },
                LetterKey.VK_T => new string[] { "ट", "ठ", "त", "थ", "त्र" },
                LetterKey.VK_U => new string[] { "उ" },
                LetterKey.VK_V => new string[] { "व" },
                LetterKey.VK_Y => new string[] { "य" },
                _ => Array.Empty<String>(),
            };
        }
    }
